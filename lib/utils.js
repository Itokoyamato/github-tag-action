...
const default_release_types_js_1 = __importDefault(require("@semantic-release/commit-analyzer/lib/default-release-types.js"));
...
function mapCustomReleaseRules(customReleaseTypes) {
    ...
    return customReleaseTypes
        ...
        if (!default_release_types_js_1.default.includes(customRelease.release)) {
